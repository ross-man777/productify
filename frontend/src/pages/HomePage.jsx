...
{
  /* i import  { SignInButton } from "@clerk/react"; because it's needed for the sign-in functionality due to newer versions */
}
...
function HomePage() {
  ...
  {
    /*YOU CAN CHANGE IT TO TRUE TO SHOW LOADING SPINNER */
  }
