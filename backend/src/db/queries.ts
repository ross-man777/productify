...
export const getAllProducts = async () => {
  return db.query.products.findMany({
    with: { user: true },
    orderBy: (products, { desc }) => [desc(products.createdAt)], // desccending means: you will see the latest products first
    // the square brackets are used required because Drizz;e-Orm's orderBy excepts an array, even for a single column.
  });
};
